...
ActiveRecord::Schema.define(version: 20170811013232) do
  ...
  create_table "guild_update_caches", force: :cascade do |t|
    t.string   "json"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "battletag"
    t.boolean  "moderator"
    t.index "lower((character_name)::text) text_pattern_ops", name: "users_character_name_lower", unique: true, using: :btree
